...
from {{ cookiecutter.package_name }}.db import transaction
from {{ cookiecutter.package_name }}.repo import user_repo
from {{ cookiecutter.package_name }}.model import User
